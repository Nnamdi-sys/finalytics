use dioxus::prelude::*;
use crate::web::server::{get_portfolio_chart, ALL_SYMBOLS_DATALIST};
...
pub fn Portfolio() -> Element {
    ...
    let mut max_iterations = use_signal(|| 1000);
            ...
            div {
                ...
                form {
                    ...
                    onsubmit: move |e| {
                        ...
                        max_iterations.set(e.values()["max_iterations"].as_value().parse::<u64>().unwrap());
                    ...
                    label { r#for: "max_iterations", "Max Iterations" }
                    br {}
                    input {
                        id: "max_iterations",
                        name: "max_iterations",
